  ...
  const menuGroups: { label: string; items: MenuItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Bảng giá', icon: CircleDollarSign, path: '/products/prices', perms: ['pricing.manage'] },
        ...
        { label: 'Nhập từ Drive', icon: FileSpreadsheet, path: '/inventory/gdrive-import', perms: ['inventory.receive'], primary: 6 },
        { label: 'Quản lý VAT', icon: ReceiptText, path: '/inventory/vat', perms: ['cashbook.view'], primary: 7 },
        { label: 'Hạn sử dụng', icon: CalendarClock, path: '/inventory/expiry', perms: ['inventory.view'], primary: 8 },
        { label: 'Gợi ý đặt hàng', icon: TrendingUp, path: '/inventory/reorder', perms: ['inventory.view'], primary: 9 },
