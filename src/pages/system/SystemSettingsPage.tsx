...
export default function SystemSettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'employees' | 'branches' | 'warehouses' | 'teams' | 'display' | 'classifications' | 'tiers'>('employees')
  ...
  return (
    <Layout activeMenu="Cấu hình">
      <div className="p-4 md:p-10 max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
          <div className="flex border-b border-gray-100 px-6 overflow-x-auto no-scrollbar">
            ...
            >
              ...
              <span>Phân loại KH ({classifications.length})</span>
            </button>
            ...
            >
              <SlidersHorizontal size={16} />
              <span>Hạng KH ({tiers.length})</span>
            </button>
                      ...
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50 text-body-md text-gray-650">
                          {classifications.map((cc) => (
                            <tr key={cc.id} className={`hover:bg-gray-25/50 transition-colors ${!cc.is_active ? 'opacity-60 bg-gray-50/40' : ''}`}>
                              ...
                              <td className="px-6 py-4 text-center">
                                <button
                                  ...
                                  className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                                    cc.is_active ? 'bg-blue-500' : 'bg-gray-255'
                                  }`}
                                >
                                  <span
                                    className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                  ...
                  {tiers.length === 0 ? (
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50 text-body-md text-gray-650">
                          {tiers.map((ct) => (
                            <tr key={ct.id} className={`hover:bg-gray-25/50 transition-colors ${!ct.is_active ? 'opacity-60 bg-gray-50/40' : ''}`}>
                              ...
                              <td className="px-6 py-4 text-center">
                                <button
                                  ...
                                  className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                                    ct.is_active ? 'bg-blue-500' : 'bg-gray-255'
                                  }`}
                                >
                                  <span
                                    className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
          ...
          <div className="fixed inset-0 bg-gray-900/60 flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden border border-gray-100 flex flex-col">
              ...
              <form onSubmit={handleSaveTeam} className="p-6 space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="block text-body-md font-semibold text-gray-700">Mô tả nhiệm vụ nhóm</label>
                  <textarea
                    placeholder="Mô tả ngành hàng, mục tiêu doanh số nhóm..."
                    rows={3}
                    value={tmDescription}
                    onChange={(e) => setTmDescription(e.target.value)}
                    className="w-full p-3 border border-gray-100 rounded-lg text-body-md focus:outline-none focus:border-blue-500 resize-none"
                  />
                </div>
        ...
        {/* MODAL 6: CUSTOMER CLASSIFICATION CREATE / EDIT FORM */}
        {showClassModal && (
          <div className="fixed inset-0 bg-gray-900/60 flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden border border-gray-100 flex flex-col">
              <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              ...
              <form onSubmit={handleSaveClassification} className="p-6 space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 border border-gray-100 rounded-lg text-body-md focus:outline-none focus:border-blue-500 disabled:bg-gray-100 disabled:text-gray-400"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="VD: Hộ chăn nuôi, Đại lý..."
                    value={className}
        ...
        {/* MODAL 7: CUSTOMER TIER CREATE / EDIT FORM */}
        {showTierModal && (
          <div className="fixed inset-0 bg-gray-900/60 flex items-center justify-center z-50 p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden border border-gray-100 flex flex-col">
              <div className="p-6 border-b border-gray-100 flex justify-between items-center">
              ...
              <form onSubmit={handleSaveTier} className="p-6 space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    type="text"
                    required
                    placeholder="VD: Thường, Khách VIP..."
                    value={tierName}
                ...
                <div className="flex items-center gap-3 select-none">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      tierIsActive ? 'bg-blue-500' : 'bg-gray-250'
                    }`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
