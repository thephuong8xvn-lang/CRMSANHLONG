...
export default function EditProductModal({ isOpen, onClose, onSuccess, productId }: EditProductModalProps) {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const { data: linkedDisData } = await supabase
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (deleteIndErr) throw deleteIndErr
          ...
          <form onSubmit={handleSubmit} className="flex-grow flex flex-col justify-between">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-tiny font-bold text-gray-455 uppercase tracking-wider mb-2">
