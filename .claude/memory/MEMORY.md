# Memory Index — CRM Sanh Long Vetco

- [project-state.md](project-state.md) — Trạng thái hiện tại dự án, sprint đang làm, files chính
- [feedback-conventions.md](feedback-conventions.md) — Quy tắc làm việc, lỗi cần tránh, phong cách code
- [dashboard-branch-scope.md](dashboard-branch-scope.md) — ĐANG LÀM: phân quyền chi nhánh + UX trang Tổng quan (Lớp 1 DB xong, Lớp 2-4 chưa)
